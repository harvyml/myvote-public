...
var EmojiBar = function (_Component) {
  ...
  _createClass(EmojiBar, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('section', { className: this.props.className }, emojiMap.filter(this.searchEmojis).map(function (emoji, code) {
        ...
        }, emoji, ' ', _react2.default.createElement('code', { className: _this2.props.className + '-emojiCode' }, ':', code, ':'));
      }).toArray());
    }
  }]);
