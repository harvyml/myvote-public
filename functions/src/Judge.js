        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(InfoPerCategory, { contestName: contest.name, contestCode: props.user.contest, userCode: props.user.code, allGroups: allGroups, categories: categories })
                )
            )
        )
    );
...
function InfoPerCategory(props) {
    ...
    var _useReducer19 = (0, _react.useReducer)(reducer, {}),
        _useReducer20 = _slicedToArray(_useReducer19, 2),
        infoForModal = _useReducer20[0],
        setInfoForModal = _useReducer20[1];
    ...
    function modifyAllGroups(category) {
        var keys;
        if (ready) {
            _firebase2.default.database().ref('contest/' + props.contestCode + '/').orderByChild("category").equalTo(category).on("value", function (snap) {
    ...
    return _react2.default.createElement(
                    ...
                    Object.keys(allGroupsM).map(function (key) {
                        ...
                        return _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'a',
                                    { href: '#modal-vote', node: 'button', className: 'modal-trigger', onClick: function onClick() {
                                            setInfoForModal(t);
                                        } },
                                    _react2.default.createElement(
                                        'i',
        ...
        _react2.default.createElement(ModalVote, _extends({}, infoForModal, { contestCode: props.contestCode, userCode: props.userCode }))
    );
}

var ModalVote = function ModalVote(props) {
    return _react2.default.createElement(
        _reactMaterialize.Modal,
        {
            actions: [_react2.default.createElement(
                _reactMaterialize.Button,
                { flat: true, modal: 'close', node: 'button', waves: 'green' },
                'Close'
            )],
            bottomSheet: false,
            fixedFooter: false,
        ...
        _react2.default.createElement(
            'div',
            { className: 'voting-bar-container' },
            _react2.default.createElement(
                'ul',
                { className: 'voting-bar flex' },
                Array.apply(null, { length: 10 }).map(function (e, i) {
                    var k = i + 1;
                    return _react2.default.createElement(
                        'li',
                        { value: k },
                        _react2.default.createElement(
                            'a',
                            { href: '#!voted', value: k, onClick: function onClick(e) {
...
var notify = function notify() {
    return (0, _reactToastify.toast)("Default Notification !");
};

function sendScoreToDB(e, k, userCode, groupCode, contestCode) {
    //K is the index plus 1 where this component is being mapped
    _firebase2.default.database().ref('contest/' + contestCode + '/' + groupCode + '/scores').update(_defineProperty({}, userCode, k)).then(function () {
        return alert("Enviado");
    }).catch(function (err) {
        return console.log("Error enviando datos: " + err.message);
    });
}
